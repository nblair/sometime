...
<div class="alert">
<p><i><spring:message code="service.unavailable"/></i></p>

<p><spring:message code="service.unavailable.more" htmlEscape="false"/></p>

<portlet:renderURL var="returnUrl" windowState="normal">
	<portlet:param name="availableAction" value="ownerSelect"/>
</portlet:renderURL>
<a class="returnLink" href="${returnUrl}"><spring:message code="retry"/></a>
</div>
