...
import org.jasig.schedassist.portlet.web.AuthenticationRequiredHandlerInterceptorImpl;

/**
 * Exception raised by {@link AuthenticationRequiredHandlerInterceptorImpl} in the event
 * no authentication could be detected in the request.
 *  
 * @author Nicholas Blair, nblair@doit.wisc.edu
 * @version $Id: AuthenticationRequiredException.java 770 2009-07-07 18:36:51Z npblair $
 */
