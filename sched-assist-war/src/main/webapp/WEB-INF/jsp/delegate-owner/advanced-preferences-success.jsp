...
<p><spring:message code="advanced.sharing.preferences.updated.resource"/>:</p>
<ul>
<c:if test="${createdPublicProfile}">
<li><spring:message code="advanced.sharing.preferences.profile.created.resource"/>:&nbsp;<a href="<c:url value="/public/profiles/${publicProfileKey}.html"/>"><c:url value="/public/profiles/${publicProfileKey}.html"/></a>.
<spring:message code="advanced.sharing.preferences.profile.search.disclaimer"/></li>
</c:if>
<c:if test="${removedPublicProfile}">
<li><spring:message code="advanced.sharing.preferences.profile.removed.resource"/></li>
</c:if>
<c:if test="${updatedPublicProfile}">
<li><spring:message code="advanced.sharing.preferences.profile.updated.resource"/></li>
</c:if>
</ul>
